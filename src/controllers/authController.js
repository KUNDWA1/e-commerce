...
exports.updateUser = exports.logout = exports.resetPassword = exports.forgotPassword = exports.changePassword = exports.getProfile = exports.login = exports.register = void 0;
...
const getProfile = async (req, res) => {
    try {
        ...
        const user = await User_1.default.findById(userId).select("-password -resetPasswordToken -resetPasswordExpires");
        if (!user)
...
const updateUser = async (req, res) => {
    try {
        ...
        const user = await User_1.default.findByIdAndUpdate(userId, { name, email }, { new: true }).select("-password -resetPasswordToken -resetPasswordExpires");
        if (!user)
            return res.status(404).json({ message: "User not found" });
        res.status(200).json(user);
    }
